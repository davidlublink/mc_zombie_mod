...
public class ZombiefeidBowItem extends ZombieModsModElements.ModElement {
	@ObjectHolder("zombie_mods:zombiefeid_bow")
	public static final Item block = null;
	@ObjectHolder("zombie_mods:entitybulletzombiefeid_bow")
	public static final EntityType arrow = null;
	public ZombiefeidBowItem(ZombieModsModElements instance) {
		super(instance, 47);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletzombiefeid_bow").setRegistryName("entitybulletzombiefeid_bow"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(2800));
			setRegistryName("zombiefeid_bow");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 4f, 7.5, 10);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Blocks.SUGAR_CANE, (int) (1));
		}
