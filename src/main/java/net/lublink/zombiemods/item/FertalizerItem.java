...
public class FertalizerItem extends ZombieModsModElements.ModElement {
	@ObjectHolder("zombie_mods:fertalizer")
	public static final Item block = null;
	public FertalizerItem(ZombieModsModElements instance) {
		super(instance, 9);
	}
