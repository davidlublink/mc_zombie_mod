...
package net.lublink.zombiemods.world.structure;
...
public class BetterDiamondTreeStructure extends ZombieModsModElements.ModElement {
	public BetterDiamondTreeStructure(ZombieModsModElements instance) {
		super(instance, 3);
	}
