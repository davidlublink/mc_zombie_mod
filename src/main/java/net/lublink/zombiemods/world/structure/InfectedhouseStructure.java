...
public class InfectedhouseStructure extends ZombieModsModElements.ModElement {
	public InfectedhouseStructure(ZombieModsModElements instance) {
		super(instance, 4);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zombie_mods", "infectedhouse"));
						if (template == null)
							return false;
