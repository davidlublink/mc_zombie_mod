...
public class TestBlockDestroyedByPlayerProcedure extends ZombieModsModElements.ModElement {
	public TestBlockDestroyedByPlayerProcedure(ZombieModsModElements instance) {
		super(instance, 32);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (!world.getWorld().isRemote) {
			Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
					.getTemplateDefaulted(new ResourceLocation("zombie_mods", "betterdiamondtree"));
			if (template != null) {
				template.addBlocksToWorld(world, new BlockPos((int) (x + 5), (int) y, (int) z),
