...
import net.lublink.zombiemods.procedures.YmakeOnKeyPressedProcedure;
...
public class YmakeKeyBinding extends ZombieModsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public YmakeKeyBinding(ZombieModsModElements instance) {
		super(instance, 43);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.ymake", GLFW.GLFW_KEY_Y, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				YmakeOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
