...
import net.lublink.zombiemods.procedures.XmakeOnKeyPressedProcedure;
...
public class XmakeKeyBinding extends ZombieModsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public XmakeKeyBinding(ZombieModsModElements instance) {
		super(instance, 40);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.xmake", GLFW.GLFW_KEY_X, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				XmakeOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
