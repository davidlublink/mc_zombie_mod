...
import net.lublink.zombiemods.procedures.DiamondrowOnKeyPressedProcedure;
...
public class DiamondrowKeyBinding extends ZombieModsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public DiamondrowKeyBinding(ZombieModsModElements instance) {
		super(instance, 44);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.diamondrow", GLFW.GLFW_KEY_LEFT, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				DiamondrowOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
