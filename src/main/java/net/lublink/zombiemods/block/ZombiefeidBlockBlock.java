...
public class ZombiefeidBlockBlock extends ZombieModsModElements.ModElement {
	@ObjectHolder("zombie_mods:zombiefeid_block")
	public static final Block block = null;
	public ZombiefeidBlockBlock(ZombieModsModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("zombiefeid_block");
		}
