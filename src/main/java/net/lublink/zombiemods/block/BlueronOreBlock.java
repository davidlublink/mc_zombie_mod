...
public class BlueronOreBlock extends ZombieModsModElements.ModElement {
	@ObjectHolder("zombie_mods:blueron_ore")
	public static final Block block = null;
	public BlueronOreBlock(ZombieModsModElements instance) {
		super(instance, 58);
	}
